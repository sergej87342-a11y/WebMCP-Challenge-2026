...
- `create_booking` не реализовывать до отдельного запроса.

## Следующая точка

Первый write-срез спроектирован и ожидает отдельного запроса на реализацию `create_booking`; до него код и тесты не добавлять.
